...
import { Compass, Headset } from 'lucide-react';
  ...
  return (
    <div className="cta-sidebar">
      ...
      >
        ...
        <span className="cta-tooltip">Live Agent</span>
      </button>

      <a 
        href="https://wa.me/917207214848?text=Hi,%20I'd%20like%20to%20connect%20with%20a%20Live%20Agent%20at%20Velo%20Realty." 
        target="_blank" 
